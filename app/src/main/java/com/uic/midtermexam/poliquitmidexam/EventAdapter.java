...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.CustomViewHolder>  {
        ...
        public void onBindViewHolder(final EventAdapter.CustomViewHolder holder, int position) {
            ...
            FirebaseStorage.getInstance().getReferenceFromUrl("gs://poliquitmidexam.appspot.com/").child(currentEvent.imageURL+ ".png").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
